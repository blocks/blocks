...
;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  return (function(modules) {
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let inherits = __webpack_require__(12)
      function AlgoliaSearchError(message, extraProperties) {
        let forEach = __webpack_require__(2)
        let error = this
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let immediate = __webpack_require__(55)
      let splitter = /\s+/
      module.exports = {
        onSync: onSync,
        onAsync: onAsync,
    ...
    function(module, exports, __webpack_require__) {
      ...
      let errors = __webpack_require__(5)
      ...
      ;(function(global, factory) {
        ...
        let Zepto = (function() {
          ...
          function likeArray(obj) {
            let length = Boolean(obj) && `length` in obj && obj.length
            let type = $.type(obj)
            return (
              `function` != type &&
              !isWindow(obj) &&
          ...
          zepto.qsa = function(element, selector) {
            ...
            let nameOnly = maybeID || maybeClass ? selector.slice(1) : selector
          ...
          $.fn = {
            ...
            wrap: function(structure) {
              ...
              let clone = dom.parentNode || this.length > 1
            ...
            text: function(text) {
              return 0 in arguments
                ? this.each(function(idx) {
                    ...
                    this.textContent = newText == null ? `` : String(newText)
                  })
                : 0 in this
            ...
            position: function() {
              ...
              let parentOffset = rootNodeRE.test(offsetParent[0].nodeName)
                ? { top: 0, left: 0 }
                : offsetParent.offset()
              ...
              let nodes = $.map(arguments, function(arg) {
                ...
                if (argType == `array`) {
                  arg.forEach(function(el) {
                    ...
                    if ($.zepto.isZ(el)) return (arr = arr.concat(el.get()))
        ...
        ;(function($) {
          let data = {}
          let dataAttr = $.fn.data
          let camelize = $.camelCase
          let exp = ($.expando = `Zepto` + Number(new Date()))
          let emptyArray = []
          function getData(node, name) {
            let id = node[exp]
            let store = id && data[id]
          ...
          function setData(node, name, value) {
            let id = node[exp] || (node[exp] = ++$.uuid)
            let store = data[id] || (data[id] = attributeData(node))
    ...
    function(module, exports, __webpack_require__) {
      ...
      _.mixin(EventBus.prototype, {
        trigger: function(type) {
          let args = [].slice.call(arguments, 1)
          let event = _.Event(namespace + type)
    ...
    function(module, exports, __webpack_require__) {
      ...
      let _zepto = __webpack_require__(14)
      let _zepto2 = _interopRequireDefault(_zepto)
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let _main = __webpack_require__(22)
      let _main2 = _interopRequireDefault(_main)
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj }
      }
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      Object.defineProperty(exports, `__esModule`, { value: true })
      let _toFactory = __webpack_require__(23)
      let _toFactory2 = _interopRequireDefault(_toFactory)
      let _DocSearch = __webpack_require__(24)
      let _DocSearch2 = _interopRequireDefault(_DocSearch)
      let _version = __webpack_require__(20)
      let _version2 = _interopRequireDefault(_version)
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj }
      }
      let docsearch = (0, _toFactory2.default)(_DocSearch2.default)
    ...
    function(module, exports, __webpack_require__) {
      ...
      let _hogan = __webpack_require__(25)
      let _hogan2 = _interopRequireDefault(_hogan)
      let _lite = __webpack_require__(28)
      let _lite2 = _interopRequireDefault(_lite)
      let _autocomplete = __webpack_require__(51)
      let _autocomplete2 = _interopRequireDefault(_autocomplete)
      let _templates = __webpack_require__(66)
      let _templates2 = _interopRequireDefault(_templates)
      let _utils = __webpack_require__(67)
      let _utils2 = _interopRequireDefault(_utils)
      let _version = __webpack_require__(20)
      let _version2 = _interopRequireDefault(_version)
      let _zepto = __webpack_require__(19)
      let _zepto2 = _interopRequireDefault(_zepto)
      function _interopRequireDefault(obj) {
        return obj && obj.__esModule ? obj : { default: obj }
      }
      ...
      let DocSearch = (function() {
        function DocSearch(_ref) {
          let apiKey = _ref.apiKey
          let indexName = _ref.indexName
          let inputSelector = _ref.inputSelector
          let _ref$appId = _ref.appId
          let appId = _ref$appId === undefined ? `BH4D9OD16A` : _ref$appId
          let _ref$debug = _ref.debug
          let debug = _ref$debug === undefined ? false : _ref$debug
          let _ref$algoliaOptions = _ref.algoliaOptions
          let algoliaOptions =
            _ref$algoliaOptions === undefined ? {} : _ref$algoliaOptions
          let _ref$autocompleteOpti = _ref.autocompleteOptions
          let autocompleteOptions =
            _ref$autocompleteOpti === undefined
              ? { debug: false, hint: false, autoselect: true }
              : _ref$autocompleteOpti
          let _ref$transformData = _ref.transformData
          let transformData =
            _ref$transformData === undefined ? false : _ref$transformData
          let _ref$queryHook = _ref.queryHook
          let queryHook = _ref$queryHook === undefined ? false : _ref$queryHook
          let _ref$handleSelected = _ref.handleSelected
          let handleSelected =
            _ref$handleSelected === undefined ? false : _ref$handleSelected
          let _ref$enhancedSearchIn = _ref.enhancedSearchInput
          let enhancedSearchInput =
            _ref$enhancedSearchIn === undefined ? false : _ref$enhancedSearchIn
          let _ref$layout = _ref.layout
          let layout = _ref$layout === undefined ? `collumns` : _ref$layout
          ...
          [
            ...
            },
            {
              ...
              value: function handleShown(input) {
                let middleOfInput = input.offset().left + input.width() / 2
                let middleOfWindow = (0, _zepto2.default)(document).width() / 2
                ...
                let otherAlignClass =
                  middleOfInput - middleOfWindow < 0
                    ? `algolia-autocomplete-right`
                    : `algolia-autocomplete-left`
                let autocompleteWrapper = (0, _zepto2.default)(
          ...
          [
            ...
            },
            {
              ...
              value: function bindSearchBoxEvent() {
                ...
                ;(0, _zepto2.default)(`input#docsearch`).on(
                  `keyup`,
                  function() {
                    let searchbox = document.querySelector(`input#docsearch`)
            ...
            },
            {
              ...
              value: function getInputFromSelector(selector) {
                let input = (0, _zepto2.default)(selector).filter(`input`)
            ...
            },
            {
              ...
              value: function formatHits(receivedHits) {
                let clonedHits = _utils2.default.deepClone(receivedHits)
                let hits = clonedHits.map(function(hit) {
                ...
                let groupedHits = _utils2.default.groupBy(hits, `lvl0`)
                _zepto2.default.each(groupedHits, function(level, collection) {
                  let groupedHitsByLvl1 = _utils2.default.groupBy(
                    collection,
                    `lvl1`
                  )
                  let flattenedHits = _utils2.default.flattenAndFlagFirst(
                    groupedHitsByLvl1,
                    `isSubCategoryHeader`
                  )
                ...
                return groupedHits.map(function(hit) {
                  ...
                  let category = _utils2.default.getHighlightedValue(
                    hit,
                    `lvl0`
                  )
                  let subcategory =
                    _utils2.default.getHighlightedValue(hit, `lvl1`) || category
                  let displayTitle = _utils2.default
                    .compact([
                  ...
                  let text = _utils2.default.getSnippetedValue(hit, `content`)
                  let isTextOrSubcatoryNonEmpty =
                    (subcategory && subcategory !== ``) ||
                    (displayTitle && displayTitle !== ``)
                  let isLvl1EmptyOrDuplicate =
                    !subcategory ||
                    subcategory === `` ||
            ...
            },
            {
              ...
              value: function formatURL(hit) {
                ...
                if (url) {
                  let containsAnchor = url.indexOf(`#`) !== -1
            ...
            },
            {
              ...
              value: function getSuggestionTemplate(isSimpleLayout) {
                let stringTemplate = isSimpleLayout
                  ? _templates2.default.suggestionSimple
                  : _templates2.default.suggestion
                let template = _hogan2.default.compile(stringTemplate)
    ...
    function(module, exports, __webpack_require__) {
      let Hogan = __webpack_require__(26)
      ...
      ;(function(Hogan) {
        ...
        Hogan.Template.prototype = {
          ...
          d: function(key, ctx, partials, returnFound) {
            ...
            let doModelGet = this.options.modelGet
            let cx = null
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let AlgoliaSearchCore = __webpack_require__(29)
      let createAlgoliasearch = __webpack_require__(41)
      module.exports = createAlgoliasearch(AlgoliaSearchCore, `(lite) `)
    },
    function(module, exports, __webpack_require__) {
      module.exports = AlgoliaSearchCore
      let errors = __webpack_require__(5)
      let exitPromise = __webpack_require__(30)
      let IndexCore = __webpack_require__(31)
      let store = __webpack_require__(38)
      let MAX_API_KEY_LENGTH = 500
      let RESET_APP_DATA_TIMER =
      ...
      function AlgoliaSearchCore(applicationID, apiKey, opts) {
        let debug = __webpack_require__(6)(`algoliasearch`)
        let clone = __webpack_require__(4)
        let isArray = __webpack_require__(7)
        let map = __webpack_require__(8)
        let usage = `Usage: algoliasearch(applicationID, apiKey, opts)`
        ...
        if (!opts.hosts) {
          let defaultHosts = map(this._shuffleResult, function(hostNumber) {
      ...
      AlgoliaSearchCore.prototype._jsonRequest = function(initialOpts) {
        this._checkAppIdData()
        let requestDebug = __webpack_require__(6)(
          `algoliasearch:` + initialOpts.url
        )
        let body
        let additionalUA = initialOpts.additionalUA || ``
        let cache = initialOpts.cache
        let client = this
        let tries = 0
        ...
        function doRequest(requester, reqOpts) {
          ...
          let currentHost = client._getHostByType(initialOpts.hostType)
          let url = currentHost + reqOpts.url
          let options = {
            body: reqOpts.body,
          ...
          function success(httpResponse) {
            ...
            let httpResponseOk = Math.floor(status / 100) === 2
            ...
            let shouldRetry = Math.floor(status / 100) !== 4
            if (shouldRetry) {
              tries += 1
              return retryRequest()
            }
            requestDebug(`unrecoverable error`)
            let unrecoverableError = new errors.AlgoliaSearchError(
        ...
        let promise = doRequest(client._request, {
          url: initialOpts.url,
      ...
      AlgoliaSearchCore.prototype._computeRequestHeaders = function(
        ...
        let forEach = __webpack_require__(2)
        let ua = additionalUA ? this._ua + `;` + additionalUA : this._ua
        let requestHeaders = {
          'x-algolia-agent': ua,
      ...
      AlgoliaSearchCore.prototype.search = function(queries, opts, callback) {
        let isArray = __webpack_require__(7)
        let map = __webpack_require__(8)
        let usage = `Usage: client.search(arrayOfQueries[, callback])`
        if (!isArray(queries)) {
          throw new Error(usage)
        }
        ...
        let JSONPParams = map(postObj.requests, function prepareJSONPParams(
          request,
          requestId
        ) {
          return (
      ...
      AlgoliaSearchCore.prototype._getAppIdData = function() {
        let data = store.get(this.applicationID)
      ...
      AlgoliaSearchCore.prototype._partialAppIdDataUpdate = function(newData) {
        let foreach = __webpack_require__(2)
        let currentData = this._getAppIdData()
      ...
      AlgoliaSearchCore.prototype._setHostIndexByType = function(
        ...
        let clone = __webpack_require__(4)
        let newHostIndexes = clone(this._hostIndexes)
      ...
      AlgoliaSearchCore.prototype._incrementTimeoutMultipler = function() {
        let timeoutMultiplier = Math.max(this._timeoutMultiplier + 1, 4)
      ...
      function safeJSONStringify(obj) {
        ...
        let toJSON = Array.prototype.toJSON
    ...
    function(module, exports, __webpack_require__) {
      let buildSearchMethod = __webpack_require__(13)
      let deprecate = __webpack_require__(32)
      let deprecatedMessage = __webpack_require__(33)
      ...
      IndexCore.prototype.browse = function(query, queryParameters, callback) {
        let merge = __webpack_require__(34)
        let indexObj = this
        let page
        let hitsPerPage
        if (
        ...
        let params = this.as._getSearchParams(queryParameters, ``)
      ...
      IndexCore.prototype.searchForFacetValues = function(params, callback) {
        let clone = __webpack_require__(4)
        let omit = __webpack_require__(35)
        let usage = `Usage: index.searchForFacetValues({facetName, facetQuery, ...params}[, callback])`
        if (params.facetName === undefined || params.facetQuery === undefined) {
          throw new Error(usage)
        }
        let facetName = params.facetName
        let filteredParams = omit(clone(params), function(keyName) {
          return keyName === `facetName`
        })
        let searchParameters = this.as._getSearchParams(filteredParams, ``)
        return this.as._jsonRequest({
          method: `POST`,
          url:
            `/1/indexes/` +
      ...
      IndexCore.prototype.getObjects = function(
        ...
        let isArray = __webpack_require__(7)
        let map = __webpack_require__(8)
        let usage = `Usage: index.getObjects(arrayOfObjectIDs[, callback])`
        ...
        let body = {
          requests: map(objectIDs, function prepareRequest(objectID) {
            let request = { indexName: indexObj.indexName, objectID: objectID }
    ...
    function(module, exports) {
      module.exports = function deprecatedMessage(previousUsage, newUsage) {
        let githubAnchorLink = previousUsage
          .toLowerCase()
          .replace(/[\.\(\)]/g, ``)
        return (
          `algoliasearch: \`` +
    ...
    function(module, exports, __webpack_require__) {
      module.exports = function omit(obj, test) {
        let keys = __webpack_require__(36)
        let foreach = __webpack_require__(2)
        let filtered = {}
    ...
    function(module, exports, __webpack_require__) {
      ...
      let slice = Array.prototype.slice
      let isArgs = __webpack_require__(37)
      let isEnumerable = Object.prototype.propertyIsEnumerable
      let hasDontEnumBug = !isEnumerable.call({ toString: null }, `toString`)
      let hasProtoEnumBug = isEnumerable.call(function() {}, `prototype`)
      let dontEnums = [
        `toString`,
        `toLocaleString`,
        `valueOf`,
      ...
      let equalsConstructorPrototypeIfNotBuggy = function(o) {
      ...
      let keysShim = function keys(object) {
        ...
        let skipProto = hasProtoEnumBug && isFunction
      ...
      keysShim.shim = function shimObjectKeys() {
        if (Object.keys) {
          let keysWorksWithArguments = (function() {
    ...
    function(module, exports, __webpack_require__) {
      ;(function(global) {
        let debug = __webpack_require__(6)(
          `algoliasearch:src/hostIndexState.js`
        )
        let localStorageNamespace = `algoliasearch-client-js`
        let store
        let moduleStore = {
          state: {},
    ...
    function(module, exports, __webpack_require__) {
      ...
      function createDebug(namespace) {
        function debug() {
          ...
          let logFn = debug.log || exports.log || console.log.bind(console)
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let global = __webpack_require__(42)
      let Promise = global.Promise || __webpack_require__(43).Promise
      module.exports = function createAlgoliasearch(AlgoliaSearch, uaSuffix) {
        let inherits = __webpack_require__(12)
        let errors = __webpack_require__(5)
        let inlineHeaders = __webpack_require__(45)
        let jsonpRequest = __webpack_require__(47)
        let places = __webpack_require__(48)
        uaSuffix = uaSuffix || ``
        if (false) {
          require(`debug`).enable(`algoliasearch*`)
        }
        function algoliasearch(applicationID, apiKey, opts) {
          let cloneDeep = __webpack_require__(4)
          let getDocumentProtocol = __webpack_require__(49)
          opts = cloneDeep(opts || {})
        ...
        AlgoliaSearchBrowser.prototype._request = function request(url, opts) {
          return new Promise(function wrapRequest(resolve, reject) {
            ...
            let body = opts.body
            let req = support.cors ? new XMLHttpRequest() : new XDomainRequest()
            let reqTimeout
            let timedOut
            let connected = false
      ...
      ;(function(process, global) {
        ...
        ;(function(global, factory) {
          ...
          function attemptVertx() {
            try {
              let r = require
              let vertx = __webpack_require__(44)
          ...
          let TRY_CATCH_ERROR = new ErrorObject()
    ...
    function(module, exports, __webpack_require__) {
      ...
      let encode = __webpack_require__(46)
    ...
    function(module, exports, __webpack_require__) {
      ...
      function jsonpRequest(url, opts, cb) {
        ...
        let cbName = `algoliaJSONP_` + JSONPCounter
        let done = false
        ...
        let ontimeout = setTimeout(timeout, opts.timeouts.complete)
    ...
    function(module, exports, __webpack_require__) {
      ...
      function createPlacesClient(algoliasearch) {
        return function places(appID, apiKey, opts) {
          ...
          let client = algoliasearch(appID, apiKey, opts)
          let index = client.initIndex(`places`)
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let zepto = __webpack_require__(14)
      let DOM = __webpack_require__(1)
      DOM.element = zepto
      let _ = __webpack_require__(0)
      ...
      _.Event = zepto.Event
      let typeaheadKey = `aaAutocomplete`
      let Typeahead = __webpack_require__(53)
      let EventBus = __webpack_require__(15)
      function autocomplete(selector, options, datasets, typeaheadObject) {
        datasets = _.isArray(datasets) ? datasets : [].slice.call(arguments, 2)
        let inputs = zepto(selector).each(function(i, input) {
          let $input = zepto(input)
          let eventBus = new EventBus({ el: $input })
          let typeahead =
            typeaheadObject ||
            new Typeahead({
              input: $input,
              ...
              hint: options.hint === undefined ? true : Boolean(options.hint),
          ...
          function(method) {
            inputs.autocomplete[method] = function() {
              ...
              inputs.each(function(j, input) {
                let typeahead = zepto(input).data(typeaheadKey)
      ...
      let wasAutocompleteSet = `autocomplete` in window
      let oldAutocomplete = window.autocomplete
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let attrsKey = `aaAttrs`
      let _ = __webpack_require__(0)
      let DOM = __webpack_require__(1)
      let EventBus = __webpack_require__(15)
      let Input = __webpack_require__(54)
      let Dropdown = __webpack_require__(61)
      let html = __webpack_require__(16)
      let css = __webpack_require__(11)
      function Typeahead(o) {
        ...
        this.autoselect = Boolean(o.autoselect)
        this.autoselectOnBlur = Boolean(o.autoselectOnBlur)
        this.openOnFocus = Boolean(o.openOnFocus)
        this.minLength = _.isNumber(o.minLength) ? o.minLength : 1
        this.autoWidth = o.autoWidth === undefined ? true : Boolean(o.autoWidth)
        o.hint = Boolean(o.hint)
        ...
        let domElts = buildDom(o)
        this.$node = domElts.wrapper
        let $input = (this.$input = domElts.input)
        $menu = domElts.menu
        $hint = domElts.hint
      ...
      _.mixin(Typeahead.prototype, {
        ...
        _onCursorMoved: function onCursorMoved(event, updateInput) {
          let datum = this.dropdown.getDatumForCursor()
          let currentCursorId = this.dropdown.getCurrentCursor().attr(`id`)
        ...
        _onRedrawn: function onRedrawn() {
          ...
          let inputRect = this.$input[0].getBoundingClientRect()
          if (this.autoWidth) {
            this.$node.css(`width`, inputRect.width + `px`)
          }
          let wrapperRect = this.$node[0].getBoundingClientRect()
          let top = inputRect.bottom - wrapperRect.top
          this.$node.css(`top`, top + `px`)
          let left = inputRect.left - wrapperRect.left
        ...
        _setLanguageDirection: function setLanguageDirection() {
          let dir = this.input.getLanguageDirection()
          if (this.dir !== dir) {
            this.dir = dir
        ...
        _select: function select(datum) {
          ...
          this.input.setInputValue(datum.value, true)
          this._setLanguageDirection()
          let event = this.eventBus.trigger(
            `selected`,
            datum.raw,
            datum.datasetName
          )
        ...
        open: function open() {
          if (!this.isActivated) {
            let query = this.input.getInputValue()
            if (query.length >= this.minLength) {
              this.dropdown.update(query)
            } else {
              this.dropdown.empty()
      ...
      function buildDom(options) {
        ...
        let dropdownHtml = html.dropdown
    ...
    function(module, exports, __webpack_require__) {
      ...
      let _ = __webpack_require__(0)
      let DOM = __webpack_require__(1)
      let EventEmitter = __webpack_require__(10)
      function Input(o) {
        let that = this
        let onBlur
        let onFocus
      ...
      _.mixin(Input.prototype, EventEmitter, {
        ...
        _onKeydown: function onKeydown($e) {
          let keyName = specialKeyCodeMap[$e.which || $e.keyCode]
        ...
        hasOverflow: function hasOverflow() {
          let constraint = this.$input.width() - 2
    ...
    function(module, exports, __webpack_require__) {
      ...
      function nextTick() {
        ...
        draining = true
        let len = queue.length
        let timeout = setTimeout(cleanUpNextTick)
        while (len) {
          currentQueue = queue
          queue = []
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      ;(function(global) {
        let Mutation = global.MutationObserver || global.WebKitMutationObserver
        exports.test = function() {
          return Mutation
        }
        exports.install = function(handle) {
          let called = 0
          let observer = new Mutation(handle)
          let element = global.document.createTextNode(``)
    ...
    function(module, exports, __webpack_require__) {
      ...
      let DOM = __webpack_require__(1)
      let EventEmitter = __webpack_require__(10)
      let Dataset = __webpack_require__(62)
      let css = __webpack_require__(11)
      function Dropdown(o) {
        let that = this
        let onSuggestionClick
        let onSuggestionMouseEnter
        let onSuggestionMouseLeave
        o = o || {}
        if (!o.menu) {
      ...
      _.mixin(Dropdown.prototype, EventEmitter, {
        ...
        _onSuggestionMouseEnter: function onSuggestionMouseEnter($e) {
          let elt = DOM.element($e.currentTarget)
          if (
            elt.hasClass(
        ...
        _onSuggestionMouseLeave: function onSuggestionMouseLeave($e) {
          if ($e.relatedTarget) {
            let elt = DOM.element($e.relatedTarget)
            if (
              elt.closest(
                `.` +
                  _.className(
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let datasetKey = `aaDataset`
      let valueKey = `aaValue`
      let datumKey = `aaDatum`
      let _ = __webpack_require__(0)
      let DOM = __webpack_require__(1)
      let html = __webpack_require__(16)
      let css = __webpack_require__(11)
      ...
      function Dataset(o) {
        ...
        this.query = null
        this._isEmpty = true
        this.highlight = Boolean(o.highlight)
        this.name =
        ...
        this.cssClasses.prefix =
          o.cssClasses.formattedPrefix ||
          _.formatPrefix(this.cssClasses.prefix, this.cssClasses.noPrefix)
        let clazz = _.className(this.cssClasses.prefix, this.cssClasses.dataset)
        this.$el =
      ...
      Dataset.extractDatum = function extractDatum(el) {
        let datum = DOM.element(el).data(datumKey)
      ...
      _.mixin(Dataset.prototype, EventEmitter, {
        _render: function render(query, suggestions) {
          ...
          let that = this
          let hasSuggestions
          let renderArgs = [].slice.call(arguments, 2)
          this.$el.empty()
          ...
          function getSuggestionsHtml() {
            ...
            let nodes
            let self = this
            let suggestionsHtml = html.suggestions
              .replace(`%PREFIX%`, this.cssClasses.prefix)
            ...
            function getSuggestionNode(suggestion) {
              let $el
              let suggestionHtml = html.suggestion
    ...
    function(module, exports, __webpack_require__) {
      'use strict'
      let _ = __webpack_require__(0)
      let version = __webpack_require__(17)
      let parseAlgoliaClientVersion = __webpack_require__(18)
      module.exports = function search(index, params) {
        let algoliaVersion = parseAlgoliaClientVersion(index.as._ua)
        if (
          algoliaVersion &&
          algoliaVersion[0] >= 3 &&
          algoliaVersion[1] > 20
    ...
    function(module, exports, __webpack_require__) {
      ...
      module.exports = function popularIn(index, params, details, options) {
        ...
        let source = _.isFunction(details.source)
          ? details.source
          : function(hit) {
        ...
        let detailsIndex = details.index
        options = options || {}
        return sourceFn
        function sourceFn(query, cb) {
          index.search(query, params, function(error, content) {
            ...
            if (content.hits.length > 0) {
              let first = content.hits[0]
              let detailsParams = _.mixin({ hitsPerPage: 0 }, details)
              delete detailsParams.source
              delete detailsParams.index
              let detailsAlgoliaVersion = parseAlgoliaClientVersion(
                detailsIndex.as._ua
              )
              if (
              ...
              detailsIndex.search(source(first), detailsParams, function(
                ...
                if (options.includeAll) {
                  let label = options.allTitle || `All departments`
                  suggestions.push(
                    _.mixin(
                ...
                for (let i = 1; i < content.hits.length; ++i) {
    ...
    function(module, exports, __webpack_require__) {
      ...
      let utils = {
        mergeKeyWithParent: function mergeKeyWithParent(object, property) {
          ...
          let newObject = _zepto2.default.extend({}, object, object[property])
        ...
        flattenAndFlagFirst: function flattenAndFlagFirst(object, flag) {
          let values = this.values(object).map(function(collection) {
